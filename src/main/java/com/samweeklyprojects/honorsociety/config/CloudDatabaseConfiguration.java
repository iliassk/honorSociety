...
@Configuration
@EnableMongoRepositories("com.samweeklyprojects.honorsociety.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.samweeklyprojects.honorsociety.config.dbmigrations");
